  ...
  return (
    <Table.Row height={40}>
      <Table.TextCell flexBasis={100} flexShrink={0} flexGrow={0}>
        <svg className={`inline-block cursor-pointer hover:fill-yellow-300 ${currency.isSelected ? 'fill-yellow-300' : ''}`} onClick={() => iconClick()} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
